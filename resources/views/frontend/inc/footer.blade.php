            ...
            <div class="col-lg-3 ml-xl-auto col-md-4 mr-0">
                <div class="text-center text-md-left mt-6">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2 mb-display-none">
                           <span class="d-block opacity-30" style="float: left; padding-right: 5px;">{{ translate('Address') }}:</span>
                           <span class="d-block opacity-70">{{ get_setting('contact_address') }}</span>
                        </li>
                        <li class="mb-2">
                           <span class="d-block opacity-30" style="float: left; padding-right: 5px;">{{translate('Phone')}}:</span>
                           <span class="d-block opacity-70">{{ get_setting('contact_phone') }}</span>
                        </li>
                        <li class="mb-2">
                           <span class="d-block opacity-30" style="float: left; padding-right: 5px;">{{translate('Email')}}:</span>
                    ...
                    <div class="w-300px mw-100 mx-auto mx-md-0 mt-6">
                        ...
                        <li class="mb-2">
                            <a class="opacity-50 hov-opacity-100 text-reset" href="{{ route('orders.track') }}">
                                {{ translate('Track Order') }}
                                    ...
                                    <div class="text-center text-md-left mt-6">
                        <h4 class="col-sm-4 d-inline-block fs-13 text-uppercase fw-600 border-bottom border-gray-900 pb-2 mb-4">
                            {{ translate('Be a Seller') }}
                        </h4>
                        <a href="{{ route('shops.create') }}" class="col-sm-4 btn btn-primary btn-xs shadow-md">
                            {{ translate('Apply Now') }}
                        </a>
                    </div>
            </div>
