...
// Custom ajax request route
Route::controller(HomeController::class)->group(function () {
    Route::post('top-categories-request', 'top_categories_request')->name('top-categories-request');
    Route::post('best-collection-request', 'best_collection_request')->name('best-collection-request');
    Route::post('product-suggest-request', 'product_suggest_request')->name('product-suggest-request');
    Route::post('more-product-suggest-request', 'more_product_suggest_request')->name('more-product-suggest-request');
    Route::post('footer-load-request', 'footer_load_request')->name('footer-load-request');
    Route::post('top-brand-request', 'top_brand_request')->name('top-brand-request');
});
